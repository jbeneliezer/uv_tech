...
{
  0xc8, 0x2a, 0x22, 0xad, 0xbd, 0xd7, 0x95, 0x95, 0x7f, 0x42, 0x12, 0x57, 0x41, 0x70, 0x76, 0x57, 
  0xab, 0xfc, 0x1b, 0x98, 0x0e, 0x4e, 0x98, 0x92, 0x03, 0x47, 0x4b, 0xb4, 0xfb, 0xdc, 0x47, 0x7f, 
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_23) = {
  .properties = 0x12,
  .max_len = 24,
  .data = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, },
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_18) = {
  .len = 16,
  .data = { 0x79, 0xc6, 0x4c, 0x3d, 0xa1, 0xb4, 0xda, 0x8f, 0xa6, 0x41, 0xed, 0xdb, 0xae, 0x90, 0xe4, 0x23, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 8,
  .data = { 0x55, 0x56, 0x20, 0x53, 0x65, 0x6e, 0x73, 0x65, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1b, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x08, .char_uuid = 0x8002 } },
  { .handle = 0x1c, .uuid = 0x8002, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
};
