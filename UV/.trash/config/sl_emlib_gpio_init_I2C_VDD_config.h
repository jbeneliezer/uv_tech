#ifndef SL_EMLIB_GPIO_INIT_I2C_VDD_CONFIG_H
#define SL_EMLIB_GPIO_INIT_I2C_VDD_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_I2C_VDD_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_I2C_VDD_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_I2C_VDD_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_I2C_VDD_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_I2C_VDD
// $[GPIO_SL_EMLIB_GPIO_INIT_I2C_VDD]
#define SL_EMLIB_GPIO_INIT_I2C_VDD_PORT          gpioPortA
#define SL_EMLIB_GPIO_INIT_I2C_VDD_PIN           0
// [GPIO_SL_EMLIB_GPIO_INIT_I2C_VDD]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_I2C_VDD_CONFIG_H
