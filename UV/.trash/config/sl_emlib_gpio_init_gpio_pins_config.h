#ifndef SL_EMLIB_GPIO_INIT_GPIO_PINS_CONFIG_H
#define SL_EMLIB_GPIO_INIT_GPIO_PINS_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_GPIO_PINS_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_GPIO_PINS_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_GPIO_PINS_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_GPIO_PINS_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_GPIO_PINS
// $[GPIO_SL_EMLIB_GPIO_INIT_GPIO_PINS]
#define SL_EMLIB_GPIO_INIT_GPIO_PINS_PORT        gpioPortC
#define SL_EMLIB_GPIO_INIT_GPIO_PINS_PIN         0
// [GPIO_SL_EMLIB_GPIO_INIT_GPIO_PINS]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_GPIO_PINS_CONFIG_H
