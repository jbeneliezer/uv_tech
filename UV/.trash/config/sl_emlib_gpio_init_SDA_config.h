#ifndef SL_EMLIB_GPIO_INIT_SDA_CONFIG_H
#define SL_EMLIB_GPIO_INIT_SDA_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_SDA_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_SDA_MODE        gpioModeWiredAndPullUpFilter

// <o SL_EMLIB_GPIO_INIT_SDA_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_SDA_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_SDA
// $[GPIO_SL_EMLIB_GPIO_INIT_SDA]
// [GPIO_SL_EMLIB_GPIO_INIT_SDA]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_SDA_CONFIG_H
